...
{
    public partial class EveryYearCase : Form
    {
        string accountstyle; 
        public EveryYearCase()
        {
            InitializeComponent();
        }
        ...
        public void FillDgvPer()
        {
            try
            {
                DateTime dt = Convert.ToDateTime(cmbYear.Text +  "-1-1");
                ...
                adp.Fill(ds, "Account");
                dgvEachYear.DataSource = ds.Tables["Account"];
        ...
        public void YearCheck()
        {
            ...
            else if (Convert.ToInt32(cmbYear.Text) == 9999)
            {
                MessageBox.Show("当年份为9999年时，会使程序加一年操作出错", "错误");
                cmbYear.Text = "9998";
            }
        }
        ...
        {            
            try
            {
                ...
                dreader.Close();
                lbTotal.Text = "当年共收入" + strIncome + "元，支出" + strOutcome + "元，盈余" + strGet + "元。";
                aConnection.Close();
            }
            catch 
            {
        ...
        private void EveryYearCase_Load(object sender, EventArgs e)
        {
